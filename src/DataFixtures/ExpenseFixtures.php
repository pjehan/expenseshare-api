...
class ExpenseFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $icelandAccommodation->setCreatedAt((new \DateTime())->sub(new \DateInterval('P5D')));
        ...
        $icelandCar->setCreatedAt((new \DateTime())->sub(new \DateInterval('P8D')));
        ...
        $icelandShopping->setCreatedAt((new \DateTime())->sub(new \DateInterval('P2D')));
        ...
        $niceBus->setCreatedAt((new \DateTime())->sub(new \DateInterval('P15D')));
